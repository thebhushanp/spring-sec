...
function create() {
    ...
    renderInitDropPts(this);
	 ...
	 for (var i = 1; i <= 13; i++) {
		 var image = this.add.image((winW * 0.2) + i * 80, winH * .8, 'card_' + i)
...
function renderUserNames(game) {
    // phPlyName1 = this.add.text(16, 230, 'Player 1', {
    // fontSize : '32px',
    // fill : '#000'
    // });
    // phPlyName2 = this.add.text(350, 16, 'Player 2', {
    // fontSize : '32px',
    // fill : '#000'
    // });
    // phPlyName3 = this.add.text(1050, 230, 'Player 3', {
    // fontSize : '32px',
    // fill : '#000'
    // });
    // phPlyMe = this.add.text(400, 700, displayName, {
    // fontSize : '32px',
    // fill : '#000'
    // });
    //	
	...
	game.input.on('dragend', function(pointer, gameObject, dragX, dragY) {
        ...
        for (var i = 0; i < validDropPoints.length; i++) {
            ...
            if (Phaser.Geom.Intersects.RectangleToRectangle(cardBounds,
                    validDropPoints[i].getBounds()) && validDropPoints[i].name == gameObject.name
